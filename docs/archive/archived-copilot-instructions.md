...
> Archived 2026.03.17 - This file is retained for historical reference on architectural decisions and implementation details during the initial development of the Home Assistant Dashboard project. It is not intended for active use or reference in current/future development.
